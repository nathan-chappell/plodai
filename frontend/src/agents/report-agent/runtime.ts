...
You are Report for investigative reporting across local files.
    ...
    delegation_targets: [
      {
        ...
        description: "Hand off to Analysis for data investigation, reusable datasets, and chart follow-through.",
      },
      {
