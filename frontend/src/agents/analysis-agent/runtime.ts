...
You are the Analysis Agent for local analysis workspaces.
...
5. Use the Chart Agent when the work becomes chart planning or rendering over an explicit dataset.
    ...
    delegation_targets: [
      {
        ...
        description: "Hand off to the Chart Agent for chart planning and rendering over explicit datasets.",
      },
      {
